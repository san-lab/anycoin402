...
// HashCCData is a free data retrieval call binding the contract method 0x34311df9.
//
// Solidity: function HashCCData(address from, address to, uint256 amountLD, uint256 minAmountLD, uint32 dstEid, uint256 validAfter, uint256 validBefore, bytes32 nonce) pure returns(bytes32)
func (_Oftcc *OftccCaller) HashCCData(opts *bind.CallOpts, from common.Address, to common.Address, amountLD *big.Int, minAmountLD *big.Int, dstEid uint32, validAfter *big.Int, validBefore *big.Int, nonce [32]byte) ([32]byte, error) {
	var out []interface{}
...
//
// Solidity: function HashCCData(address from, address to, uint256 amountLD, uint256 minAmountLD, uint32 dstEid, uint256 validAfter, uint256 validBefore, bytes32 nonce) pure returns(bytes32)
func (_Oftcc *OftccSession) HashCCData(from common.Address, to common.Address, amountLD *big.Int, minAmountLD *big.Int, dstEid uint32, validAfter *big.Int, validBefore *big.Int, nonce [32]byte) ([32]byte, error) {
...
//
// Solidity: function HashCCData(address from, address to, uint256 amountLD, uint256 minAmountLD, uint32 dstEid, uint256 validAfter, uint256 validBefore, bytes32 nonce) pure returns(bytes32)
func (_Oftcc *OftccCallerSession) HashCCData(from common.Address, to common.Address, amountLD *big.Int, minAmountLD *big.Int, dstEid uint32, validAfter *big.Int, validBefore *big.Int, nonce [32]byte) ([32]byte, error) {
	return _Oftcc.Contract.HashCCData(&_Oftcc.CallOpts, from, to, amountLD, minAmountLD, dstEid, validAfter, validBefore, nonce)
}
...
//
// Solidity: function sendWithCCAuthorization((uint32,bytes32,uint256,uint256,bytes,bytes,bytes) _sendParam, (uint256,uint256) _fee, address _from, uint256 validAfter, uint256 validBefore, bytes32 nonce, bytes signature, address _refundAddress) returns(bool)
...
// SetMarkup is a paid mutator transaction binding the contract method 0x8cde6e0b.
//
// Solidity: function setMarkup(uint256 _markup, uint32 dstEid) returns()
func (_Oftcc *OftccTransactor) SetMarkup(opts *bind.TransactOpts, _markup *big.Int, dstEid uint32) (*types.Transaction, error) {
	return _Oftcc.contract.Transact(opts, "setMarkup", _markup, dstEid)
}

// SetMarkup is a paid mutator transaction binding the contract method 0x8cde6e0b.
//
// Solidity: function setMarkup(uint256 _markup, uint32 dstEid) returns()
func (_Oftcc *OftccSession) SetMarkup(_markup *big.Int, dstEid uint32) (*types.Transaction, error) {
	return _Oftcc.Contract.SetMarkup(&_Oftcc.TransactOpts, _markup, dstEid)
}

// SetMarkup is a paid mutator transaction binding the contract method 0x8cde6e0b.
//
// Solidity: function setMarkup(uint256 _markup, uint32 dstEid) returns()
func (_Oftcc *OftccTransactorSession) SetMarkup(_markup *big.Int, dstEid uint32) (*types.Transaction, error) {
	return _Oftcc.Contract.SetMarkup(&_Oftcc.TransactOpts, _markup, dstEid)
}
